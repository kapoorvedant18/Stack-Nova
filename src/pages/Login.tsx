    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background p-4">
      ...
      <Card className="relative w-full max-w-md border-border/70 shadow-xl">
        ...
        <CardContent className="space-y-4">
          <Button variant="outline" className="h-11 w-full rounded-xl" onClick={handleGoogleLogin}>
          ...
          <Button variant="outline" className="h-11 w-full rounded-xl" onClick={handleMicrosoftLogin}>
            <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} className="h-11 rounded-xl pl-9" required />
              </div>
            </div>
